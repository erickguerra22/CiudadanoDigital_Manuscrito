...
integrar un sistema de generación mejorada por recuperación (RAG, por sus
...
segura y eficiente con el modelo grande de lenguaje (LLM, por sus siglas en
inglés) mediante un flujo de generación mejorada por recuperación. Se
...
\begin{enumerate}
      ...
      \item \textbf{Diseño y construcción de bases de datos}
            ...
            Levantada en PostgreSQL, será la encargada de almacenar la información
            estructurada del sistema, como usuarios, chats, mensajes y sesiones, de manera
            que se mantenga la persistencia de datos y se facilite la gestión de las
      ...
      \item \textbf{Implementación del modelo LLM y flujo RAG}
            ...
            Se implementó un flujo de generación mejorada por recuperación que permite al
            asistente virtual generar respuestas fundamentadas en los contenidos educativos
            previamente indexados. Este flujo integra los siguientes componentes:
            ...
            interacción entre la base vectorial y el modelo grande de lenguaje para generar
            respuestas contextualizadas y fundamentadas. El proceso se divide en tres
            etapas principales:
...
\begin{enumerate}
      \item \textbf{Pruebas funcionales del sistema}
            ...
            Las pruebas funcionales se llevaron a cabo siguiendo un proceso estructurado
