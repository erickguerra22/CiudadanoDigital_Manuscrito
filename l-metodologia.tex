...
El producto mínimo viable (MVP, por sus siglas en inglés) obtenido al finalizar el último \textit{sprint}
...
comunicación segura y eficiente con el modelo de lenguaje (LLM, por sus siglas en inglés) mediante un
...
lenguaje (LLM, por sus siglas en inglés). Además, se buscó evaluar la calidad, precisión y confiabilidad
