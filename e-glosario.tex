...
{
    name=LLM,
    description={Large Language Model (Modelo de Lenguaje Grande o de gran escala)}
}
...
{
    name=RAG,
    description={Retrieval-Augmented Generation (Generación Aumentada por Recuperación)}
}
...
{
    name=UI,
    description={User Interface (Experiencia de Usuario)}
}
\newglossaryentry{ux}
{
    name=UX,
